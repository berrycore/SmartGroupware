...
<script >
	function idOK() {
		opener.document.frm_document.second_id.value = document.frm.second_id.value;
		opener.document.frm_document.second_name.value = document.frm.second_name.value;
		opener.document.frm_document.second_position.value = document.frm.second_position.value;
		self.close();
	}
</script>
				...
				<tbody>
					<c:if test="${ hasResult eq 'yes' }">
						<c:forEach var="user" items="${userList}">
							<tr>
								<td>${user.user_id } <input type="hidden" name="second_id" value="${user.user_id }"> </td>
								<td>${user.user_name } <input type="hidden" name="second_name" value="${user.user_name }"></td>
