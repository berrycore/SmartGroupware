	...
	<div class="container">
			 ...
			 <div class="input-group mb-3">
			    <div class="input-group-prepend">
			       <span class="input-group-text"><spring:message code="sgw.notice.title" /></span>
			...
			<button type="button" class="btn btn-success" style="margin: 5px"><spring:message code="sgw.notice.close" /></button>
			<a href="/board/NoticeDelete.html?notice_id=${notice.notice_id}"> <button type="button" class="btn btn-warning" style="margin: 5px"><spring:message code="sgw.notice.delete" /></button></a>
			<a href="/board/NoticeUpdate.html?notice_id=${notice.notice_id}"> <button type="button" class="btn btn-secondary" style="margin: 5px"><spring:message code="sgw.notice.modify" /></button></a>
			<a href="/board/NoticeListView.html"> <button type="button" class="btn btn-primary" style="margin: 5px"><spring:message code="sgw.notice.to.list" /></button> </a>
	</div>
